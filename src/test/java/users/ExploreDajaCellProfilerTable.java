...
public class ExploreDajaCellProfilerTable
{
	public static void main( String[] args )
	{
		...
		command.tableFile = new File("/Volumes/cuylen/01_Share/Filemaker/01_Experiments/0243/03_analysis/02_Concatenating-and-merging/CP_v3/02_output/R_output/e-0234-CP-v3_merged_images_nuclei_for_explore_objects_table_relative_paths_first-half.txt");
