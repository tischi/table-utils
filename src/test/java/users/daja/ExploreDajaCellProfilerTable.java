...
//		command.imageRootFolder = new File( "/Volumes" );
		...
		command.tableFile = new File("/Users/tischer/Documents/table-utils/src/test/resources/cellprofiler/output/final_table.csv");
		command.imageRootFolder = new File( "/Users/tischer/Documents/table-utils/src/test/resources/cellprofiler" );
